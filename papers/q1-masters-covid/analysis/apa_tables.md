# APA-style tables for the new Q1 paper (n = 38)

Source: `data/publication_n38.csv`. Do not mix with Rathore and Cao (2024) n = 97.

## Table 1

*Demographic and study profile of respondents*
...
*Infrastructure, home ecology, and affective outcomes*
...
| Sample | n | Unstable net % | No power % | Home × high stress p | Speed × appraisal ρ |
|---|---:|---:|---:|---|---|
